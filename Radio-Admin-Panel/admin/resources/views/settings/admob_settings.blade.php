...
@section('content')
    <section class="section">
        <form class="create-form" action="{{ route('admob-setting.update')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row mt-3">
                                ...
                                <div class="col-sm-2 col-md-12 col-xs-12  mt-2">
                                    <div class="form-check form-switch ">
                                        <input type="hidden" name="banner_ad_status" id="banner_ad_status" value="{{isset($settings['banner_ad_status']) ? $settings['banner_ad_status'] : '' }}">
                                        <input class="form-check-input" type="checkbox" role="switch" id="switch_banner_ad_status" {{ isset($settings['banner_ad_status']) && $settings['banner_ad_status'] == '1' ? 'checked' : '' }}/>
                                    </div>
                                </div>
        ...
        $(document).ready(function($) {
            ...
            $("#switch_banner_ad_status").on('change', function() {
                ...
                if ($(this).prop('checked')) {
                    $("#banner_ad_status").val(1);
                } else {
                    $("#banner_ad_status").val(0);
                }
            });
            ...
            if ($(this).prop('checked')) {
                $("#interstitial_ad_status").val(1);
            } else {
                $("#interstitial_ad_status").val(0);
            }
            });
