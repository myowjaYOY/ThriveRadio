                ...
                <li class="sidebar-item has-sub">
                    ...
                    <ul class="submenu" style="padding-left: 0rem">
                        <li class="submenu-item">
                            <a href="{{ route('app-setting.index') }}">{{ __('App Settings') }}</a>
                        </li>
                        <li class="submenu-item">
                            <a href="{{ route('system_settings') }}">{{ __('System Settings') }}</a>
                        </li>
                        <li class="submenu-item">
                            <a href="{{ route('notification_settings') }}">{{ __('Notification Settings') }}</a>
                        </li>
                        <li class="submenu-item">
                            <a href="{{ route('admob-setting.index') }}">{{ __('Admob Settings') }}</a>
                        </li>
                        <li class="submenu-item">
